...
def main(nel, cutoff,rs, gamma, kc):
    ...
    print_logging_info("{:.3f} seconds spent on evaluating effective 2-body \
                       integrals".format((time.time()-time_eff_2_body)))
    ...
    print_logging_info("contributions from 3 body to total energy:")
    ...
    print_logging_info("3-body mean-field contribution to total energy = {:.8f}"\
