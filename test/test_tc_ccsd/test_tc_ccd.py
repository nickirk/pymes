...
def test_tc_ccd_h2_hdf5():
    test_tc_ref_energy(fcidump_file="FCIDUMP.H2.tc", tcdump_file="../test_util/tcdump.h5", ref_e=-1.1660095160466279)
    test_tc_ccd_energy(fcidump_file="FCIDUMP.H2.tc", tcdump_file="../test_util/tcdump.h5", ref_e=-0.005919199166)
