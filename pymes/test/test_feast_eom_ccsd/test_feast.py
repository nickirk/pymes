...
def driver(fcidump_file="pymes/test/test_eom_ccsd/FCIDUMP.LiH.sto6g", 
    ...
    n_e = 2
    eom_cc = feast_eom_ccsd.FEAST_EOM_CCSD(no, e_c=0.184, e_r=0.01, n_trial=2, max_iter=100, tol=1e-8)
